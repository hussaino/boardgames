...
public class CheckersController extends GameController {
	...
	CheckerBoard board_;
	public CheckersController(PiecesAdapter adapter, Board board, Button submit) {
	...
	public void submitClick() {
		...
		Toast.makeText(CheckersActivity.getAppContext(), "Move submitted.", Toast.LENGTH_SHORT).show();
		}
	}
	...
	void itemClicked(int position) throws InstantiationException,
		...
		case 1: {
			...
			if (board_.Pieces_[x][y].highlight_) {
				...
				oldY = y;
				gamePhase++;
				Context context = CheckersActivity.getAppContext();
